...
public class GuiceServiceLoader<S> implements Iterable<S> {
    ...
    @Contract("_, _, _ -> fail")
    private static void fail(@NotNull Class<?> service, String msg, Throwable cause) throws ServiceConfigurationError {
        throw new ServiceConfigurationError(service.getName() + ": " + msg, cause);
    }

    @Contract("_, _ -> fail")
    private static void fail(@NotNull Class<?> service, String msg) throws ServiceConfigurationError {
     ...
     */
    private int parseLine(Class<?> service, URL u, @NotNull BufferedReader r, int lc, List<String> names) throws IOException, ServiceConfigurationError {
